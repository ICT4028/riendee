...
# 🛠️ ระบบช่างซ่อมโค้ดอัตโนมัติโดย riendee (Auto-Installer)
required_packages = ["google-generativeai", "beautifulsoup4", "requests"]
for package in required_packages:
    try:
        ...
        # ถ้าไม่มีแพ็กเกจ ให้แอบติดตั้งทันที
        subprocess.check_call([sys.executable, "-m", "pip", "install", package])

# --- เริ่มต้นโค้ดหลักของแอปพลิเคชัน riendee ---
...
if input_method == "📝 พิมพ์/วางข้อความเอง":
    ...
    quiz_topic = st.text_input("📝 พิมพ์หัวข้อเรื่องหรือบทเรียนที่ต้องการทำข้อสอบ:", placeholder="เช่น English vocabulary for daily life")
